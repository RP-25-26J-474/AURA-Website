...
function StatsCards({ stats }) {
  return (
    <div className="stats stats-vertical lg:stats-horizontal shadow-xl bg-base-100 w-full">
      <div className="stat">
        <div className="stat-figure text-primary text-4xl"><FiBarChart2 /></div>
      ...
      <div className="stat">
        <div className="stat-figure text-secondary text-4xl"><FiCpu /></div>
      ...
      <div className="stat">
        <div className="stat-figure text-accent text-4xl"><FiEdit3 /></div>
      ...
      <div className="stat">
        <div className="stat-figure text-info text-4xl"><FiClock /></div>
